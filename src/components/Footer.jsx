    ...
    <div className="py-6 md:py-8">
      <div className="gap-4 space-y-5 xl:flex xl:items-center xl:justify-between xl:space-y-0">
        <a href="#" title="" className="block">
          ...
          <img className="block h-8 w-auto dark:block" src={logo2} alt="" />
        </a>

        <p className="text-sm text-gray-500 dark:text-gray-400">© 2025 <a href="#" className="hover:underline">SP Packwell</a>, Inc. All rights reserved.</p>
      </div>
    </div>
  </div>
</footer>
